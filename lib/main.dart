...
class _MainPageState extends State<MainPage> {
  ...
  Widget showPage(int selectedPage){
    print(selectedPage);
    switch(selectedPage){
      case 0 : return CustomSwiper(); break;
      case 1 : return CustomStack(); break;
      case 2 : return CustomEmptyContainer(); break;
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          backgroundColor: Color(0xff292F33),
          child: SvgPicture.asset('assets/1f423.svg',width: 30,),
        ),
        appBar: KeepBar(
          height: 70.0,
        ),
